...
{
private:
	char* _type = nullptr;// Верхняя, Повседневная, Домашняя 
	char* _obj = nullptr;// Брюки или халат или пальто
	char* _country = nullptr;// Страна производитель
	uint16_t _price = -1;// Стоимость по прайсу 
public:
